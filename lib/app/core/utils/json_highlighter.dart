...
TextStyle _mono(double s) => TextStyle(
  fontSize: s,
  height: 1.7,
  fontFamily: AppFonts.mono,
  color: AppColors.foreground,
);
TextStyle _keyStyle(double s) => TextStyle(
  fontSize: s,
  height: 1.7,
  fontFamily: AppFonts.mono,
...
TextStyle _stringStyle(double s) => TextStyle(
  fontSize: s,
  height: 1.7,
  fontFamily: AppFonts.mono,
  color: AppColors.green,
);
TextStyle _numberStyle(double s) => TextStyle(
  fontSize: s,
  height: 1.7,
  fontFamily: AppFonts.mono,
  color: AppColors.yellow,
);
TextStyle _boolStyle(double s) => TextStyle(
  fontSize: s,
  height: 1.7,
  fontFamily: AppFonts.mono,
  color: AppColors.magenta,
);
TextStyle _varStyle(double s) => TextStyle(
  fontSize: s,
  height: 1.7,
  fontFamily: AppFonts.mono,
...
TextStyle _punctStyle(double s) => TextStyle(
  fontSize: s,
  height: 1.7,
  fontFamily: AppFonts.mono,
...
List<TextSpan> _stringSpans(
  ...
  for (final m in matches) {
    if (m.start > last) {
      out.add(
        TextSpan(text: inner.substring(last, m.start), style: stringStyle),
      );
    }
